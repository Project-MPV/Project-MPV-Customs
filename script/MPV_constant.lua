...
TYPE_REBIRTH     = 0x400000000
TYPES_TOKEN      = TYPE_MONSTER+TYPE_NORMAL+TYPE_TOKEN
TYPE_EXTRA       = TYPE_FUSION+TYPE_SYNCHRO+TYPE_XYZ+TYPE_LINK+TYPE_REBIRTH
TYPE_MAXIMUM     = 0x8000
...
EFFECT_TYPE_REMATERIAL = 0x8000+EFFECT_TYPE_XMATERIAL
--Effect flags
...
EFFECT_REBIRTH_MAT_RESTRICTION      = 73941492+TYPE_REBIRTH
--Events
EVENT_STARTUP              = 1000
EVENT_FLIP                 = 1001
