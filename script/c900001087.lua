...
function s.filter(c)
	return c:IsSetCard(0x7988) and c:IsMonster() and c:IsAbleToHand()
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local v=e:GetHandler():GetBaseAttack()
