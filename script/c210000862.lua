...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	--skill effect
	local card1=Duel.CreateToken(tp,200009369)
	local card2=Duel.CreateToken(tp,200009369)
	local card3=Duel.CreateToken(tp,200009708)
